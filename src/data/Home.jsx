const home = [
  ...
  // présentation concept 2, avec bouton
  {
    ...
    data: {
      ...
      clsPara: "md:w-1/2",
      clsBouton:
        "transition hover:bg-rose hover:text-vert hover:border-rose active:-skew-y-6 active:translate-y-1 shadow-blanc/30 shadow-[10px_10px_0px_0px] shadow-vert/50 active:shadow-blanc/20 bg-vert border-blanc border-2 text-blanc px-6 py-2",
